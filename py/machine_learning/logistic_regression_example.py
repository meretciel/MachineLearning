...
model = LogisticRegression(C=100.0, solver='lbfgs', multi_class='multinomial')
...
plot_decision_regions(axs[0], X_train_std[:, 0], X_train_std[:, 1], y_train, model, marker_alpha=1.0)
axs[0].set_title("Training")
plot_decision_regions(axs[1], X_test_std[:, 0], X_test_std[:, 1], y_test, model, x1_range=(x1_min, x1_max), x2_range=(x2_min, x2_max), marker_alpha=1.0)
